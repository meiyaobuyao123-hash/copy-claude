...
function nV(A, B) {
  if (!Ol6.test(A))
    ((A = 'google/protobuf/' + A + '.proto'),
      (B = { nested: { google: { nested: { protobuf: { nested: B } } } } }));
  nV[A] = B;
}
nV('any', {
...
nV('timestamp', { Timestamp: EI2 });
nV('empty', { Empty: { fields: {} } });
nV('struct', {
...
nV('field_mask', { FieldMask: { fields: { paths: { rule: 'repeated', type: 'string', id: 1 } } } });
nV.get = function A(B) {
  return nV[B] || null;
};
