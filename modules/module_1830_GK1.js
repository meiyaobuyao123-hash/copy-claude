...
Jj[_9.SVG] = { __proto__: null, foreignObject: !0, desc: !0, title: !0 };
Jj[_9.MATHML] = {
  __proto__: null,
  mi: !0,
  mo: !0,
...
Mo1[_9.HTML] = { __proto__: null, address: !0, div: !0, p: !0 };
var Gz2 = Object.create(null);
Gz2[_9.HTML] = { __proto__: null, dd: !0, dt: !0 };
var qd = Object.create(null);
qd[_9.HTML] = { __proto__: null, table: !0, thead: !0, tbody: !0, tfoot: !0, tr: !0 };
...
BK1[_9.HTML] = { __proto__: null, table: !0, template: !0, html: !0 };
var QK1 = Object.create(null);
QK1[_9.HTML] = { __proto__: null, tbody: !0, tfoot: !0, thead: !0, template: !0, html: !0 };
var Lo1 = Object.create(null);
Lo1[_9.HTML] = { __proto__: null, tr: !0, template: !0, html: !0 };
...
Rw[_9.SVG] = { __proto__: null, foreignObject: !0, desc: !0, title: !0 };
...
Wz2[_9.HTML] = { __proto__: null, html: !0, table: !0, template: !0 };
var G55 = Object.create(null);
G55[_9.HTML] = { __proto__: null, optgroup: !0, option: !0 };
var Fz2 = Object.create(null);
Fz2[_9.MATHML] = { __proto__: null, mi: !0, mo: !0, mn: !0, ms: !0, mtext: !0 };
var Jz2 = Object.create(null);
Jz2[_9.SVG] = { __proto__: null, foreignObject: !0, desc: !0, title: !0 };
var cH2 = {
    __proto__: null,
...
function Az2(A) {
  for (var B = 0, Q = A.length; B < Q; B++) if (A[B][0] in lH2) A[B][0] = lH2[A[B][0]];
}
function Bz2(A) {
...
function qo1(A) {
  for (var B = 0, Q = A.length; B < Q; B++) if (A[B][0] in cH2) A[B].push(cH2[A[B][0]]);
}
function Qz2(A, B) {
...
Z5.ElementStack.prototype.popElementType = function (A) {
  for (var B = this.elements.length - 1; B > 0; B--) if (this.elements[B] instanceof A) break;
  ((this.elements.length = B), (this.top = this.elements[B - 1]));
};
Z5.ElementStack.prototype.popElement = function (A) {
  for (var B = this.elements.length - 1; B > 0; B--) if (this.elements[B] === A) break;
  ((this.elements.length = B), (this.top = this.elements[B - 1]));
};
...
Z5.ElementStack.prototype.clearToContext = function (A) {
  for (var B = this.elements.length - 1; B > 0; B--) if (u5(this.elements[B], A)) break;
...
Z5.ActiveFormattingElements.prototype.MARKER = { localName: '|' };
...
function Z5(A, B, Q) {
      ...
      parse: function (s, e, u1) {
        ...
        if (W === 0) {
          ...
          if (
            ...
            ((I = J + I.substring(D)), (G = I.length), (D = 0), (J = ''));
          W--;
        }
        return TA;
      },
      ...
      switch (typeof V.lookahead) {
        ...
        case 'number':
          ...
          if (y0 < G - D) ((u1 = i2 ? I.substring(D, D + y0) : null), (xA = !1));
            ...
            if (((u1 = i2 ? I.substring(D, G) : null), (xA = !0), e === 65535 && D === G - 1))
              e = tV1;
          } else return !0;
          V(e, u1, xA);
          break;
  ...
  function E1(s, e) {
    for (var u1 = 0; u1 < g.length; u1++) if (g[u1][0] === s) return;
  ...
  function N1() {
    ...
    for (var xA = 0; xA < g.length; xA++) if (g[xA][0] === e) return !0;
...
`)
  ...
  var j2 = (NA.insertToken = function s(e, u1, TA, xA) {
    ...
    if (!y0 || y0.namespaceURI === _9.HTML) r(e, u1, TA, xA);
      ...
      (tH2(y0) && (e === $d || (e === UD && u1 !== 'mglyph' && u1 !== 'malignmark'))) ||
      (e === UD &&
        u1 === 'svg' &&
        y0.namespaceURI === _9.MATHML &&
        y0.localName === 'annotation-xml') ||
      eH2(y0)
    )
      ((B1 = !0), r(e, u1, TA, xA), (B1 = !1));
    else PZ(e, u1, TA, xA);
  });
  function y9(s) {
    var e = x.top;
  ...
  function zB(s, e, u1) {
    ...
    if (u1) for (var xA = 0, y0 = u1.length; xA < y0; xA++) TA._setAttribute(u1[xA][0], u1[xA][1]);
    return TA;
  }
  var H6 = !1;
  function T2(s, e) {
  ...
  function x4(s) {
    ...
    else if (x.top instanceof d5.HTMLTemplateElement)
      ((e = s(x.top.content.ownerDocument)), x.top.content._appendChild(e));
  ...
  function U2(s) {
    for (var e = x.elements.length - 1; e >= 0; e--) if (x.elements[e] instanceof s) return e;
    return -1;
  }
  function r2(s) {
    var e,
      ...
      y0;
    if (
      ((TA = U2(d5.HTMLTableElement)),
      (xA = U2(d5.HTMLTemplateElement)),
      xA >= 0 && (TA < 0 || xA > TA))
    )
      e = x.elements[xA];
    else if (TA >= 0)
  ...
  function iB(s, e) {
    return { elt: zB(s, F1.list[e].localName, F1.attrs[e]), attrs: F1.attrs[e] };
  }
  function z6() {
    ...
    while (e < 8) {
      ...
      if (!xA) return (x.popElement(u1), F1.remove(u1), !0);
        ...
        while (!0) {
          ...
          if (
            (F1.replace(U6, c3.elt, c3.attrs), (x.elements[E3] = c3.elt), (U6 = c3.elt), U8 === xA)
          )
            (F1.remove(H3), F1.insertAfter(c3.elt, H3));
        ...
        (xA._appendChild(RI.elt),
          F1.remove(u1),
          F1.replace(H3, RI.elt, RI.attrs),
          x.removeElement(u1));
  ...
  function OQ() {
    if ((delete OA._parser, (x.elements.length = 0), OA.defaultView))
      OA.defaultView.dispatchEvent(new d5.Event('load', {}));
  }
  function V2(s, e) {
    ((V = e), D--);
  }
...
`
    ...
    switch (s) {
      ...
      case 5:
        var xA = e,
          ...
          i2 = TA;
        if (
          (OA.appendChild(new t65(OA, xA, y0, i2)),
          FA ||
            xA.toLowerCase() !== 'html' ||
            B55.test(y0) ||
            (i2 && i2.toLowerCase() === Q55) ||
            (i2 === void 0 && pH2.test(y0)))
        )
          OA._quirks = !0;
      ...
      case 2:
        switch (e) {
          ...
          case 'script':
            (x4(function (y0) {
              var i2 = zB(y0, e, u1);
              if (((i2._parser_inserted = !0), (i2._force_async = !1), x1))
                i2._already_started = !0;
              return (E2(), i2);
            }),
              (V = IB),
              (w1 = r),
      ...
      case 3:
        switch (e) {
          ...
          case 'template':
            ...
            (x.generateImpliedEndTags(null, 'thorough'),
              x.popTag('template'),
              F1.clearToMarker(),
              H1.pop(),
              T6());
      ...
      case 2:
        switch (e) {
          ...
          case 'body':
            if (
              ((xA = x.elements[1]),
              !xA || !(xA instanceof d5.HTMLBodyElement) || x.contains('template'))
            )
              return;
            ((cA = !1), Qz2(u1, xA));
            return;
          ...
          case 'select':
            if (
              (z6(), T2(e, u1), (cA = !1), r === p5 || r === TQ || r === LG || r === E6 || r === p3)
            )
              r = dC;
            else r = Y7;
            return;
    ...
    switch (s) {
      ...
      case 3:
        switch (e) {
          case 'optgroup':
            if (
              x.top instanceof d5.HTMLOptionElement &&
              x.elements[x.elements.length - 2] instanceof d5.HTMLOptGroupElement
            )
              Y7(V6, 'option');
  ...
  function PZ(s, e, u1, TA) {
    function xA(U6) {
      for (var U8 = 0, E3 = U6.length; U8 < E3; U8++)
        switch (U6[U8][0]) {
          case 'color':
          case 'face':
          case 'size':
    ...
    switch (s) {
      ...
      case 2:
        switch (e) {
          ...
          case 'var':
            if (x1) break;
            do (x.pop(), (y0 = x.top));
            while (y0.namespaceURI !== _9.HTML && !tH2(y0) && !eH2(y0));
            j2(s, e, u1, TA);
            return;
        }
        if (((y0 = x.elements.length === 1 && x1 ? B : x.top), y0.namespaceURI === _9.MATHML))
          Bz2(u1);
      ...
      case 3:
        if (
          ((y0 = x.top), e === 'script' && y0.namespaceURI === _9.SVG && y0.localName === 'script')
        )
          x.pop();
        else {
  ...
  return (
    (NA.testTokenizer = function (s, e, u1, TA) {
      var xA = [];
      switch (e) {
        case 'PCDATA state':
          V = N9;
