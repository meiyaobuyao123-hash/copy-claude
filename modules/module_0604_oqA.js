...
function cS9(A) {
  let B = gS9(A),
    ...
    D = 'and or not only',
    Z = '[a-zA-Z-][a-zA-Z0-9_-]*',
    Y = { className: 'variable', begin: '(\\$[a-zA-Z-][a-zA-Z0-9_-]*)\\b' };
  return {
    name: 'SCSS',
    case_insensitive: !0,
    illegal: "[=/|']",
    contains: [
      ...
      { className: 'selector-tag', begin: '\\b(' + hS9.join('|') + ')\\b', relevance: 0 },
      { className: 'selector-pseudo', begin: ':(' + I.join('|') + ')' },
      { className: 'selector-pseudo', begin: '::(' + Q.join('|') + ')' },
      Y,
      { begin: /\(/, end: /\)/, contains: [A.CSS_NUMBER_MODE] },
      { className: 'attribute', begin: '\\b(' + pS9.join('|') + ')\\b' },
      {
        begin:
      ...
      { begin: '@(page|font-face)', lexemes: '@[a-z-]+', keywords: '@page @font-face' },
      {
        ...
        returnBegin: !0,
        keywords: { $pattern: /[a-z-]+/, keyword: 'and or not only', attribute: mS9.join(' ') },
        contains: [
