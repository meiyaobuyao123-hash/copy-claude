...
(function (A) {
  ...
  else if (typeof lB1 === 'object' && typeof gp5 === 'object') A(Q(B, Q(gp5)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((vrA = function (D, Z) {
    ...
    (arA = function (D, Z) {
      for (var Y in D)
        if (Y !== 'default' && !Object.prototype.hasOwnProperty.call(Z, Y)) cB1(Z, D, Y);
    }),
    (cB1 = Object.create
      ? function (D, Z, Y, W) {
          if (W === void 0) W = Y;
    ...
    (srA = function () {
      for (var D = [], Z = 0; Z < arguments.length; Z++) D = D.concat(VS1(arguments[Z]));
      return D;
    }),
    (rrA = function () {
    ...
    (Av = function (D) {
      return this instanceof Av ? ((this.v = D), this) : new Av(D);
    }),
    (trA = function (D, Z, Y) {
      ...
      function K(M) {
        M.value instanceof Av ? Promise.resolve(M.value.v).then(U, N) : q(J[0][2], M);
      }
      function U(M) {
        V('next', M);
      }
    ...
    (erA = function (D) {
      ...
      function W(F, J) {
        Z[F] = D[F]
          ? function (C) {
              return (Y = !Y) ? { value: Av(D[F](C)), done: !1 } : J ? J(C) : C;
            }
          : J;
      }
    }),
    (AoA = function (D) {
      ...
      return Z
        ? Z.call(D)
        : ((D = typeof pB1 === 'function' ? pB1(D) : D[Symbol.iterator]()),
          (Y = {}),
          W('next'),
          W('throw'),
          W('return'),
  ...
  ((QoA = function (D) {
    ...
    var Z = {};
    if (D != null) {
      for (var Y = I(D), W = 0; W < Y.length; W++) if (Y[W] !== 'default') cB1(Z, D, Y[W]);
    }
    return (Q(Z, D), Z);
  }),
    (IoA = function (D) {
  ...
  ((WoA = function (D) {
    ...
    A('__param', mrA),
    A('__esDecorate', drA),
    A('__runInitializers', urA),
    A('__propKey', prA),
    A('__setFunctionName', crA),
    A('__metadata', lrA),
    A('__awaiter', irA),
    A('__generator', nrA),
    A('__exportStar', arA),
    A('__createBinding', cB1),
    A('__values', pB1),
    A('__read', VS1),
    A('__spread', srA),
    A('__spreadArrays', rrA),
    A('__spreadArray', orA),
    A('__await', Av),
    A('__asyncGenerator', trA),
    A('__asyncDelegator', erA),
    A('__asyncValues', AoA),
    A('__makeTemplateObject', BoA),
    A('__importStar', QoA),
    A('__importDefault', IoA),
    A('__classPrivateFieldGet', GoA),
    A('__classPrivateFieldSet', DoA),
    A('__classPrivateFieldIn', ZoA),
    A('__addDisposableResource', YoA),
    A('__disposeResources', WoA),
    A('__rewriteRelativeImportExtension', FoA));
});
