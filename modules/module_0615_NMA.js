...
function W_9(A) {
  let B = Q_9(A),
    Q = 'and or not only',
    I = { className: 'variable', begin: '\\$' + A.IDENT_RE },
    G = [
      'charset',
      'css',
      'debug',
  ...
  return {
    ...
    contains: [
      ...
      { className: 'selector-pseudo', begin: '&?:(' + D_9.join('|') + ')(?=[.\\s\\n[:,(])' },
      { className: 'selector-pseudo', begin: '&?::(' + Z_9.join('|') + ')(?=[.\\s\\n[:,(])' },
      B.ATTRIBUTE_SELECTOR_MODE,
      {
        ...
        starts: {
          ...
          keywords: { $pattern: /[a-z-]+/, keyword: 'and or not only', attribute: G_9.join(' ') },
          contains: [A.CSS_NUMBER_MODE],
        },
      },
      { className: 'keyword', begin: '@((-(o|moz|ms|webkit)-)?(' + G.join('|') + '))\\b' },
      I,
      A.CSS_NUMBER_MODE,
      {
        className: 'function',
