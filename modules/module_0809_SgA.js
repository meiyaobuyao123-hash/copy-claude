...
(function (A) {
  ...
  else if (typeof r51 === 'object' && typeof dm5 === 'object') A(Q(B, Q(dm5)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((BgA = function (D, Z) {
    ...
    (VgA = function (D, Z) {
      for (var Y in D)
        if (Y !== 'default' && !Object.prototype.hasOwnProperty.call(Z, Y)) s51(Z, D, Y);
    }),
    (s51 = Object.create
      ? function (D, Z, Y, W) {
          if (W === void 0) W = Y;
    ...
    (KgA = function () {
      for (var D = [], Z = 0; Z < arguments.length; Z++) D = D.concat(xO1(arguments[Z]));
      return D;
    }),
    (HgA = function () {
    ...
    (Mf = function (D) {
      return this instanceof Mf ? ((this.v = D), this) : new Mf(D);
    }),
    (wgA = function (D, Z, Y) {
      ...
      function K(M) {
        M.value instanceof Mf ? Promise.resolve(M.value.v).then(U, N) : q(J[0][2], M);
      }
      function U(M) {
        V('next', M);
      }
    ...
    (EgA = function (D) {
      ...
      function W(F, J) {
        Z[F] = D[F]
          ? function (C) {
              return (Y = !Y) ? { value: Mf(D[F](C)), done: !1 } : J ? J(C) : C;
            }
          : J;
      }
    }),
    (UgA = function (D) {
      ...
      return Z
        ? Z.call(D)
        : ((D = typeof a51 === 'function' ? a51(D) : D[Symbol.iterator]()),
          (Y = {}),
          W('next'),
          W('throw'),
          W('return'),
  ...
  (($gA = function (D) {
    ...
    var Z = {};
    if (D != null) {
      for (var Y = I(D), W = 0; W < Y.length; W++) if (Y[W] !== 'default') s51(Z, D, Y[W]);
    }
    return (Q(Z, D), Z);
  }),
    (qgA = function (D) {
  ...
  ((TgA = function (D) {
    ...
    A('__param', DgA),
    A('__esDecorate', ZgA),
    A('__runInitializers', YgA),
    A('__propKey', WgA),
    A('__setFunctionName', FgA),
    A('__metadata', JgA),
    A('__awaiter', CgA),
    A('__generator', XgA),
    A('__exportStar', VgA),
    A('__createBinding', s51),
    A('__values', a51),
    A('__read', xO1),
    A('__spread', KgA),
    A('__spreadArrays', HgA),
    A('__spreadArray', zgA),
    A('__await', Mf),
    A('__asyncGenerator', wgA),
    A('__asyncDelegator', EgA),
    A('__asyncValues', UgA),
    A('__makeTemplateObject', NgA),
    A('__importStar', $gA),
    A('__importDefault', qgA),
    A('__classPrivateFieldGet', MgA),
    A('__classPrivateFieldSet', LgA),
    A('__classPrivateFieldIn', RgA),
    A('__addDisposableResource', OgA),
    A('__disposeResources', TgA),
    A('__rewriteRelativeImportExtension', PgA));
});
