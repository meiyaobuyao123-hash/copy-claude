...
(function (A) {
  ...
  else if (typeof ZB1 === 'object' && typeof ku5 === 'object') A(Q(B, Q(ku5)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((dlA = function (D, Z) {
    ...
    (elA = function (D, Z) {
      for (var Y in D)
        if (Y !== 'default' && !Object.prototype.hasOwnProperty.call(Z, Y)) DB1(Z, D, Y);
    }),
    (DB1 = Object.create
      ? function (D, Z, Y, W) {
          if (W === void 0) W = Y;
    ...
    (AiA = function () {
      for (var D = [], Z = 0; Z < arguments.length; Z++) D = D.concat(FP1(arguments[Z]));
      return D;
    }),
    (BiA = function () {
    ...
    (bf = function (D) {
      return this instanceof bf ? ((this.v = D), this) : new bf(D);
    }),
    (IiA = function (D, Z, Y) {
      ...
      function K(M) {
        M.value instanceof bf ? Promise.resolve(M.value.v).then(U, N) : q(J[0][2], M);
      }
      function U(M) {
        V('next', M);
      }
    ...
    (GiA = function (D) {
      ...
      function W(F, J) {
        Z[F] = D[F]
          ? function (C) {
              return (Y = !Y) ? { value: bf(D[F](C)), done: !1 } : J ? J(C) : C;
            }
          : J;
      }
    }),
    (DiA = function (D) {
      ...
      return Z
        ? Z.call(D)
        : ((D = typeof GB1 === 'function' ? GB1(D) : D[Symbol.iterator]()),
          (Y = {}),
          W('next'),
          W('throw'),
          W('return'),
  ...
  ((YiA = function (D) {
    ...
    var Z = {};
    if (D != null) {
      for (var Y = I(D), W = 0; W < Y.length; W++) if (Y[W] !== 'default') DB1(Z, D, Y[W]);
    }
    return (Q(Z, D), Z);
  }),
    (WiA = function (D) {
  ...
  ((ViA = function (D) {
    ...
    A('__param', llA),
    A('__esDecorate', ilA),
    A('__runInitializers', nlA),
    A('__propKey', alA),
    A('__setFunctionName', slA),
    A('__metadata', rlA),
    A('__awaiter', olA),
    A('__generator', tlA),
    A('__exportStar', elA),
    A('__createBinding', DB1),
    A('__values', GB1),
    A('__read', FP1),
    A('__spread', AiA),
    A('__spreadArrays', BiA),
    A('__spreadArray', QiA),
    A('__await', bf),
    A('__asyncGenerator', IiA),
    A('__asyncDelegator', GiA),
    A('__asyncValues', DiA),
    A('__makeTemplateObject', ZiA),
    A('__importStar', YiA),
    A('__importDefault', WiA),
    A('__classPrivateFieldGet', FiA),
    A('__classPrivateFieldSet', JiA),
    A('__classPrivateFieldIn', CiA),
    A('__addDisposableResource', XiA),
    A('__disposeResources', ViA),
    A('__rewriteRelativeImportExtension', KiA));
});
