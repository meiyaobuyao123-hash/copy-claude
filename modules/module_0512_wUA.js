...
function ZT9(A) {
  let B = {
    ...
    G = {
      ...
      keywords: 'struct',
      contains: [{ className: 'type', begin: A.UNDERSCORE_IDENT_RE, relevance: 0 }],
    },
    D = [
      {
        className: 'params',
    ...
    Z = { className: 'title', begin: A.UNDERSCORE_IDENT_RE, relevance: 0 },
    Y = function (X, V, K) {
      let U = A.inherit(
        { className: 'function', beginKeywords: X, end: V, excludeEnd: !0, contains: [].concat(D) },
        K || {}
      );
      return (
        U.contains.push(Z),
        U.contains.push(A.C_NUMBER_MODE),
        U.contains.push(A.C_BLOCK_COMMENT_MODE),
        U.contains.push(Q),
        U
      );
    },
    W = { className: 'built_in', begin: '\\b(' + B.built_in.split(' ').join('|') + ')\\b' },
    F = { className: 'string', begin: '"', end: '"', contains: [A.BACKSLASH_ESCAPE], relevance: 0 },
    J = {
      ...
      relevance: 0,
      contains: [
        { beginKeywords: B.keyword },
        W,
        { className: 'built_in', begin: A.UNDERSCORE_IDENT_RE, relevance: 0 },
      ],
    },
    C = {
      begin: /\(/,
      ...
      relevance: 0,
      keywords: { built_in: B.built_in, literal: B.literal },
      contains: [A.C_NUMBER_MODE, A.C_BLOCK_COMMENT_MODE, Q, W, J, F, 'self'],
    };
  return (
    J.contains.push(C),
    {
      ...
      contains: [
        ...
        Y('fn', '='),
        {
          ...
          relevance: 0,
          contains: [A.C_BLOCK_COMMENT_MODE, Q, C],
        },
        {
          variants: [
