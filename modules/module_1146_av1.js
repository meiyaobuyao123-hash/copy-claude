...
(function (A) {
  ...
  else if (typeof vD1 === 'object' && typeof KF8 === 'object') A(Q(B, Q(KF8)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((rE0 = function (D, Z) {
    ...
    (WU0 = function (D, Z) {
      for (var Y in D)
        if (Y !== 'default' && !Object.prototype.hasOwnProperty.call(Z, Y)) fD1(Z, D, Y);
    }),
    (fD1 = Object.create
      ? function (D, Z, Y, W) {
          if (W === void 0) W = Y;
    ...
    (FU0 = function () {
      for (var D = [], Z = 0; Z < arguments.length; Z++) D = D.concat(nv1(arguments[Z]));
      return D;
    }),
    (JU0 = function () {
    ...
    (sb = function (D) {
      return this instanceof sb ? ((this.v = D), this) : new sb(D);
    }),
    (XU0 = function (D, Z, Y) {
      ...
      function K(M) {
        M.value instanceof sb ? Promise.resolve(M.value.v).then(U, N) : q(J[0][2], M);
      }
      function U(M) {
        V('next', M);
      }
    ...
    (VU0 = function (D) {
      ...
      function W(F, J) {
        Z[F] = D[F]
          ? function (C) {
              return (Y = !Y) ? { value: sb(D[F](C)), done: !1 } : J ? J(C) : C;
            }
          : J;
      }
    }),
    (KU0 = function (D) {
      ...
      return Z
        ? Z.call(D)
        : ((D = typeof xD1 === 'function' ? xD1(D) : D[Symbol.iterator]()),
          (Y = {}),
          W('next'),
          W('throw'),
          W('return'),
  ...
  ((zU0 = function (D) {
    ...
    var Z = {};
    if (D != null) {
      for (var Y = I(D), W = 0; W < Y.length; W++) if (Y[W] !== 'default') fD1(Z, D, Y[W]);
    }
    return (Q(Z, D), Z);
  }),
    (wU0 = function (D) {
  ...
  ((qU0 = function (D) {
    ...
    A('__param', AU0),
    A('__esDecorate', BU0),
    A('__runInitializers', QU0),
    A('__propKey', IU0),
    A('__setFunctionName', GU0),
    A('__metadata', DU0),
    A('__awaiter', ZU0),
    A('__generator', YU0),
    A('__exportStar', WU0),
    A('__createBinding', fD1),
    A('__values', xD1),
    A('__read', nv1),
    A('__spread', FU0),
    A('__spreadArrays', JU0),
    A('__spreadArray', CU0),
    A('__await', sb),
    A('__asyncGenerator', XU0),
    A('__asyncDelegator', VU0),
    A('__asyncValues', KU0),
    A('__makeTemplateObject', HU0),
    A('__importStar', zU0),
    A('__importDefault', wU0),
    A('__classPrivateFieldGet', EU0),
    A('__classPrivateFieldSet', UU0),
    A('__classPrivateFieldIn', NU0),
    A('__addDisposableResource', $U0),
    A('__disposeResources', qU0),
    A('__rewriteRelativeImportExtension', MU0));
});
