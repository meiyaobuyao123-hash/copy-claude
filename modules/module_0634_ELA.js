...
function u_9(A) {
  let Q = {
    ...
    Z = { className: 'number', begin: '[0-9]+#[0-9A-Z_]+(\\.[0-9-A-Z_]+)?#?([Ee][+-]?[0-9]+)?' },
    Y = { beginKeywords: 'import', end: '$', keywords: Q, contains: [I] },
    W = {
      className: 'function',
      begin: /[a-z][^\n]*->/,
      returnBegin: !0,
      end: /->/,
      contains: [A.inherit(A.TITLE_MODE, { starts: { endsWithParent: !0, keywords: Q } })],
    };
  return {
    name: 'XL',
    aliases: ['tao'],
    keywords: Q,
    contains: [A.C_LINE_COMMENT_MODE, A.C_BLOCK_COMMENT_MODE, I, G, D, W, Y, Z, A.NUMBER_MODE],
  };
}
wLA.exports = u_9;
