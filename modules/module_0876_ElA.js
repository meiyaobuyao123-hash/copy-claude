...
(function (A) {
  ...
  else if (typeof t81 === 'object' && typeof Su5 === 'object') A(Q(B, Q(Su5)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((ccA = function (D, Z) {
    ...
    (QlA = function (D, Z) {
      for (var Y in D)
        if (Y !== 'default' && !Object.prototype.hasOwnProperty.call(Z, Y)) o81(Z, D, Y);
    }),
    (o81 = Object.create
      ? function (D, Z, Y, W) {
          if (W === void 0) W = Y;
    ...
    (IlA = function () {
      for (var D = [], Z = 0; Z < arguments.length; Z++) D = D.concat(IP1(arguments[Z]));
      return D;
    }),
    (GlA = function () {
    ...
    (ff = function (D) {
      return this instanceof ff ? ((this.v = D), this) : new ff(D);
    }),
    (ZlA = function (D, Z, Y) {
      ...
      function K(M) {
        M.value instanceof ff ? Promise.resolve(M.value.v).then(U, N) : q(J[0][2], M);
      }
      function U(M) {
        V('next', M);
      }
    ...
    (YlA = function (D) {
      ...
      function W(F, J) {
        Z[F] = D[F]
          ? function (C) {
              return (Y = !Y) ? { value: ff(D[F](C)), done: !1 } : J ? J(C) : C;
            }
          : J;
      }
    }),
    (WlA = function (D) {
      ...
      return Z
        ? Z.call(D)
        : ((D = typeof r81 === 'function' ? r81(D) : D[Symbol.iterator]()),
          (Y = {}),
          W('next'),
          W('throw'),
          W('return'),
  ...
  ((JlA = function (D) {
    ...
    var Z = {};
    if (D != null) {
      for (var Y = I(D), W = 0; W < Y.length; W++) if (Y[W] !== 'default') o81(Z, D, Y[W]);
    }
    return (Q(Z, D), Z);
  }),
    (ClA = function (D) {
  ...
  ((zlA = function (D) {
    ...
    A('__param', acA),
    A('__esDecorate', scA),
    A('__runInitializers', rcA),
    A('__propKey', ocA),
    A('__setFunctionName', tcA),
    A('__metadata', ecA),
    A('__awaiter', AlA),
    A('__generator', BlA),
    A('__exportStar', QlA),
    A('__createBinding', o81),
    A('__values', r81),
    A('__read', IP1),
    A('__spread', IlA),
    A('__spreadArrays', GlA),
    A('__spreadArray', DlA),
    A('__await', ff),
    A('__asyncGenerator', ZlA),
    A('__asyncDelegator', YlA),
    A('__asyncValues', WlA),
    A('__makeTemplateObject', FlA),
    A('__importStar', JlA),
    A('__importDefault', ClA),
    A('__classPrivateFieldGet', XlA),
    A('__classPrivateFieldSet', VlA),
    A('__classPrivateFieldIn', KlA),
    A('__addDisposableResource', HlA),
    A('__disposeResources', zlA),
    A('__rewriteRelativeImportExtension', wlA));
});
