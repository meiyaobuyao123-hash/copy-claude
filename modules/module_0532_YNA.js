...
function dT9(A) {
  let I =
    ...
    D = 'CR FALSE nil NO_VALUE NULL TAB TRUE YES_VALUE ',
    Z =
    ...
    J = 'ENGLISH_LANGUAGE_CODE RUSSIAN_LANGUAGE_CODE ',
    C = 'smHidden smMaximized smMinimized smNormal wmNo wmYes ',
    X =
    ...
    V = 'COMPONENT_TOKEN_LOCK_TYPE EDOCUMENT_VERSION_LOCK_TYPE ',
    K =
    ...
    O = 'CERTIFICATE_TYPE_ENCRYPT CERTIFICATE_TYPE_SIGN CERTIFICATE_TYPE_SIGN_AND_ENCRYPT ',
    S = 'STORAGE_TYPE_FILE STORAGE_TYPE_NAS_CIFS STORAGE_TYPE_SAPERION STORAGE_TYPE_SQL_SERVER ',
    f =
    ...
    g = 'RESULT_VAR_NAME RESULT_VAR_NAME_ENG ',
    Y1 =
    ...
    H1 = 'SYSCOMP_CONTROL_JOBS SYSCOMP_FOLDERS SYSCOMP_JOBS SYSCOMP_NOTICES SYSCOMP_TASKS ',
    x =
    ...
    x1 = 'ACCESS_RIGHTS_TABLE_NAME EDMS_ACCESS_TABLE_NAME EDOC_TYPES_TABLE_NAME ',
    o1 =
    ...
    FA = 'ISBL_SYNTAX NO_SYNTAX XML_SYNTAX ',
    f1 =
    ...
    v1 =
      ...
      f1 +
      B1,
    M1 = 'atUser atGroup atRole ',
    AA =
      'aemEnabledAlways aemDisabledAlways aemEnabledOnBrowse aemEnabledOnEdit aemDisabledOnBrowseEmpty ',
    NA = 'apBegin apEnd ',
    OA = 'alLeft alRight ',
    o = 'asmNever asmNoButCustomize asmAsLastTime asmYesButCustomize asmAlways ',
    A1 = 'cirCommon cirRevoked ',
    I1 = 'ctSignature ctEncode ctSignatureEncode ',
    E1 = 'clbUnchecked clbChecked clbGrayed ',
    N1 = 'ceISB ceAlways ceNever ',
    t =
    ...
    S1 = 'cfInternal cfDisplay ',
    k1 = 'ciUnspecified ciWrite ciRead ',
    d1 =
    ...
    IA = 'cctDate cctInteger cctNumeric cctPick cctReference cctString cctText ',
    ...
    kA = 'dssEdit dssInsert dssBrowse dssInActive ',
    z0 = 'dftDate dftShortDate dftDateTime dftTimeStamp ',
    s2 = 'dotDays dotHours dotMinutes dotSeconds ',
    B2 = 'dtkndLocal dtkndUTC ',
    E2 = 'arNone arView arEdit arFull ',
    g2 = 'ddaView ddaEdit ',
    Q9 =
    ...
    o4 = 'ecotFile ecotProcess ',
    Z0 = 'eaGet eaCopy eaCreate eaCreateStandardRoute ',
    h0 = 'edltAll edltNothing edltQuery ',
    m0 = 'essmText essmCard ',
    L0 = 'esvtLast esvtLastActive esvtSpecified ',
    H0 = 'edsfExecutive edsfArchive ',
    j2 = 'edstSQLServer edstFile ',
    y9 = 'edvstNone edvstEDocumentVersionCopy edvstFile edvstTemplate edvstScannedFile ',
    z8 = 'vsDefault vsDesign vsActive vsObsolete ',
    zB = 'etNone etCertificate etPassword etCertificatePassword ',
    H6 = 'ecException ecWarning ecInformation ',
    T2 = 'estAll estApprovingOnly ',
    x4 = 'evtLast evtLastActive evtQuery ',
    f0 =
      'fdtString fdtNumeric fdtInteger fdtDate fdtText fdtUnknown fdtWideString fdtLargeInteger ',
    U2 =
      'ftInbox ftOutbox ftFavorites ftCommonFolder ftUserFolder ftComponents ftQuickLaunch ftShortcuts ftSearch ',
    r2 = 'grhAuto grhX1 grhX2 grhX3 ',
    T6 = 'hltText hltRTF hltHTML ',
    w8 = 'iffBMP iffJPEG iffMultiPageTIFF iffSinglePageTIFF iffTIFF iffPNG ',
    u3 = 'im8bGrayscale im24bRGB im1bMonochrome ',
    iB = 'itBMP itJPEG itWMF itPNG ',
    z6 = 'ikhInformation ikhWarning ikhError ikhNoIcon ',
    H3 =
    ...
    E8 = 'isShow isHide isByUserSettings ',
    QB = 'jkJob jkNotice jkControlJob ',
    OQ = 'jtInner jtLeft jtRight jtFull jtCross ',
    V2 = 'lbpAbove lbpBelow lbpLeft lbpRight ',
    N9 = 'eltPerConnection eltPerUser ',
    z3 = 'sfcUndefined sfcBlack sfcGreen sfcRed sfcBlue sfcOrange sfcLilac ',
    G7 = 'sfsItalic sfsStrikeout sfsNormal ',
    IB =
    ...
    nB = 'mrcrtNone mrcrtUser mrcrtMaximal mrcrtCustom ',
    $G = 'vtEqual vtGreaterOrEqual vtLessOrEqual vtRange ',
    OZ =
      'rdYesterday rdToday rdTomorrow rdThisWeek rdThisMonth rdThisYear rdNextMonth rdNextWeek rdLastWeek rdLastMonth ',
    D7 = 'rdWindow rdFile rdPrinter ',
    w3 =
      'rdtString rdtNumeric rdtInteger rdtDate rdtReference rdtAccount rdtText rdtPick rdtUnknown rdtLargeInteger rdtDocument ',
    OD = 'reOnChange reOnChangeValues ',
    TD = 'ttGlobal ttLocal ttUser ttSystem ',
    PD = 'ssmBrowse ssmSelect ssmMultiSelect ssmBrowseModal ',
    GB = 'smSelect smLike smCard ',
    TZ = 'stNone stAuthenticating stApproving ',
    O1 = 'sctString sctStream ',
    R1 = 'sstAnsiSort sstNaturalSort ',
    p1 = 'svtEqual svtContain ',
    JA =
    ...
    ZA = 'tarAbortByUser tarAbortByWorkflowException ',
    $A = 'tvtAllWords tvtExactPhrase tvtAnyWord ',
    rA =
      'usNone usCompleted usRedSquare usBlueSquare usYellowSquare usGreenSquare usOrangeSquare usPurpleSquare usFollowUp ',
    bA = 'utUnknown utUser utDeveloper utAdministrator utSystemDeveloper utDisconnected ',
    sA = 'btAnd btDetailAnd btOr btNotOr btOnly ',
    fA = 'vmView vmSelect vmNavigation ',
    iA = 'vsmSingle vsmMultiple vsmMultipleCheck vsmNoSelection ',
    P2 = 'wfatPrevious wfatNext wfatCancel wfatFinish ',
    F2 =
    ...
    $9 = 'wfetQueryParameter wfetText wfetDelimiter wfetLabel ',
    C1 =
    ...
    P1 = 'wstForm wstEDocument wstTaskCard wstReferenceRecordCard wstFinal ',
    QA = 'waAll waPerformers waManual ',
    XA =
    ...
    gA = 'wiLow wiNormal wiHigh ',
    eA = 'wrtSoft wrtHard ',
    oA = 'wsInit wsRunning wsDone wsControlled wsAborted wsContinued ',
    V0 = 'wtmFull wtmFromCurrent wtmOnlyCurrent ',
    E0 =
    ...
    L4 = v1 + E0,
    o6 = q9,
    P6 = 'null true false nil ',
    aB = { className: 'number', begin: A.NUMBER_RE, relevance: 0 },
    k7 = {
      className: 'string',
      variants: [
        { begin: '"', end: '"' },
    ...
    IW = {
      ...
      relevance: 0,
      contains: [A.PHRASAL_WORDS_MODE, SD],
    },
    x7 = {
      className: 'comment',
      begin: '/\\*',
    ...
    K4 = { begin: '\\.\\s*' + A.UNDERSCORE_IDENT_RE, keywords: _D, relevance: 0 },
    f7 = {
      className: 'type',
      begin: ':[ \\t]*(' + r9.trim().replace(/\s/g, '|') + ')',
      end: '[ \\t]*=',
      excludeEnd: !0,
    },
    jD = {
    ...
    bC = '[A-Za-zА-Яа-яёЁ_][A-Za-zА-Яа-яёЁ_0-9]*' + '\\(';
  return {
    name: 'ISBL',
    case_insensitive: !0,
    keywords: _D,
    ...
    contains: [
      {
        ...
        contains: [
          {
            className: 'title',
            keywords: { $pattern: '[A-Za-zА-Яа-яёЁ_!][A-Za-zА-Яа-яёЁ_0-9]*', built_in: d0 },
            begin: bC,
            end: '\\(',
            returnBegin: !0,
            excludeEnd: !0,
