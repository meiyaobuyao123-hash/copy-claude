...
function bP9(A) {
  let B = {
    ...
    Q = A.COMMENT('%', '$'),
    I = { className: 'number', begin: "0'.\\|0[box][0-9a-fA-F]*" },
    G = A.inherit(A.APOS_STRING_MODE, { relevance: 0 }),
    D = A.inherit(A.QUOTE_STRING_MODE, { relevance: 0 }),
    Z = {
      className: 'subst',
