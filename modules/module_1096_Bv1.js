...
(function (A) {
  ...
  else if (typeof sG1 === 'object' && typeof ZW8 === 'object') A(Q(B, Q(ZW8)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((LV0 = function (Q, I) {
    ...
    (kV0 = function () {
      for (var Q = [], I = 0; I < arguments.length; I++) Q = Q.concat(Av1(arguments[I]));
      return Q;
    }),
    (xV0 = function () {
    ...
    (hb = function (Q) {
      return this instanceof hb ? ((this.v = Q), this) : new hb(Q);
    }),
    (fV0 = function (Q, I, G) {
      ...
      function J(K) {
        K.value instanceof hb ? Promise.resolve(K.value.v).then(C, X) : V(Y[0][2], K);
      }
      function C(K) {
        F('next', K);
      }
    ...
    (vV0 = function (Q) {
      ...
      function D(Z, Y) {
        I[Z] = Q[Z]
          ? function (W) {
              return (G = !G) ? { value: hb(Q[Z](W)), done: Z === 'return' } : Y ? Y(W) : W;
            }
          : Y;
      }
    }),
    (bV0 = function (Q) {
      ...
      return I
        ? I.call(Q)
        : ((Q = typeof aG1 === 'function' ? aG1(Q) : Q[Symbol.iterator]()),
          (G = {}),
          D('next'),
          D('throw'),
          D('return'),
    ...
    A('__generator', jV0),
    A('__exportStar', yV0),
    A('__createBinding', pV0),
    A('__values', aG1),
    A('__read', Av1),
    A('__spread', kV0),
    A('__spreadArrays', xV0),
    A('__await', hb),
    A('__asyncGenerator', fV0),
    A('__asyncDelegator', vV0),
    A('__asyncValues', bV0),
    A('__makeTemplateObject', gV0),
    A('__importStar', hV0),
    A('__importDefault', mV0),
    A('__classPrivateFieldGet', dV0),
    A('__classPrivateFieldSet', uV0));
});
