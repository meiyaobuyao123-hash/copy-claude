...
(function (A) {
  ...
  else if (typeof LG1 === 'object' && typeof cZ8 === 'object') A(Q(B, Q(cZ8)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((bW0 = function (D, Z) {
    ...
    (sW0 = function (D, Z) {
      for (var Y in D)
        if (Y !== 'default' && !Object.prototype.hasOwnProperty.call(Z, Y)) MG1(Z, D, Y);
    }),
    (MG1 = Object.create
      ? function (D, Z, Y, W) {
          if (W === void 0) W = Y;
    ...
    (rW0 = function () {
      for (var D = [], Z = 0; Z < arguments.length; Z++) D = D.concat($f1(arguments[Z]));
      return D;
    }),
    (oW0 = function () {
    ...
    (jb = function (D) {
      return this instanceof jb ? ((this.v = D), this) : new jb(D);
    }),
    (eW0 = function (D, Z, Y) {
      ...
      function K(M) {
        M.value instanceof jb ? Promise.resolve(M.value.v).then(U, N) : q(J[0][2], M);
      }
      function U(M) {
        V('next', M);
      }
    ...
    (AF0 = function (D) {
      ...
      function W(F, J) {
        Z[F] = D[F]
          ? function (C) {
              return (Y = !Y) ? { value: jb(D[F](C)), done: !1 } : J ? J(C) : C;
            }
          : J;
      }
    }),
    (BF0 = function (D) {
      ...
      return Z
        ? Z.call(D)
        : ((D = typeof qG1 === 'function' ? qG1(D) : D[Symbol.iterator]()),
          (Y = {}),
          W('next'),
          W('throw'),
          W('return'),
  ...
  ((IF0 = function (D) {
    ...
    var Z = {};
    if (D != null) {
      for (var Y = I(D), W = 0; W < Y.length; W++) if (Y[W] !== 'default') MG1(Z, D, Y[W]);
    }
    return (Q(Z, D), Z);
  }),
    (GF0 = function (D) {
  ...
  ((FF0 = function (D) {
    ...
    A('__param', dW0),
    A('__esDecorate', uW0),
    A('__runInitializers', pW0),
    A('__propKey', cW0),
    A('__setFunctionName', lW0),
    A('__metadata', iW0),
    A('__awaiter', nW0),
    A('__generator', aW0),
    A('__exportStar', sW0),
    A('__createBinding', MG1),
    A('__values', qG1),
    A('__read', $f1),
    A('__spread', rW0),
    A('__spreadArrays', oW0),
    A('__spreadArray', tW0),
    A('__await', jb),
    A('__asyncGenerator', eW0),
    A('__asyncDelegator', AF0),
    A('__asyncValues', BF0),
    A('__makeTemplateObject', QF0),
    A('__importStar', IF0),
    A('__importDefault', GF0),
    A('__classPrivateFieldGet', DF0),
    A('__classPrivateFieldSet', ZF0),
    A('__classPrivateFieldIn', YF0),
    A('__addDisposableResource', WF0),
    A('__disposeResources', FF0),
    A('__rewriteRelativeImportExtension', JF0));
});
