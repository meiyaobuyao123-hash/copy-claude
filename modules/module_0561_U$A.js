...
function uP9(A) {
  let B = {
    className: 'number',
    relevance: 0,
    variants: [{ begin: '[$][a-fA-F0-9]+' }, A.NUMBER_MODE],
  };
  return {
    name: 'Monkey',
    case_insensitive: !0,
    ...
    contains: [
      ...
      },
      {
        ...
        contains: [{ beginKeywords: 'extends implements' }, A.UNDERSCORE_TITLE_MODE],
      },
      ...
      { beginKeywords: 'alias', end: '=', contains: [A.UNDERSCORE_TITLE_MODE] },
      A.QUOTE_STRING_MODE,
      B,
    ],
  };
