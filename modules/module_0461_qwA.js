  ...
  let B =
    ...
    D = {
      variants: [
        ...
        A.COMMENT('#cs', '#ce'),
        A.COMMENT('#comments-start', '#comments-end'),
      ],
    },
    Z = { begin: '\\$[A-z0-9_]+' },
    Y = {
    ...
    W = { variants: [A.BINARY_NUMBER_MODE, A.C_NUMBER_MODE] },
    F = {
      className: 'meta',
      begin: '#',
      end: '$',
    ...
    J = { className: 'symbol', begin: '@[A-z0-9_]+' },
    C = {
      className: 'function',
      beginKeywords: 'Func',
      end: '$',
      ...
      contains: [
        ...
        { className: 'params', begin: '\\(', end: '\\)', contains: [Z, Y, W] },
      ],
    };
  return {
    name: 'AutoIt',
