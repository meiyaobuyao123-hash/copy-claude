...
(function (A) {
  ...
  else if (typeof PG1 === 'object' && typeof nZ8 === 'object') A(Q(B, Q(nZ8)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((zF0 = function (D, Z) {
    ...
    (PF0 = function (D, Z) {
      for (var Y in D)
        if (Y !== 'default' && !Object.prototype.hasOwnProperty.call(Z, Y)) TG1(Z, D, Y);
    }),
    (TG1 = Object.create
      ? function (D, Z, Y, W) {
          if (W === void 0) W = Y;
    ...
    (SF0 = function () {
      for (var D = [], Z = 0; Z < arguments.length; Z++) D = D.concat(Rf1(arguments[Z]));
      return D;
    }),
    (_F0 = function () {
    ...
    (yb = function (D) {
      return this instanceof yb ? ((this.v = D), this) : new yb(D);
    }),
    (yF0 = function (D, Z, Y) {
      ...
      function K(M) {
        M.value instanceof yb ? Promise.resolve(M.value.v).then(U, N) : q(J[0][2], M);
      }
      function U(M) {
        V('next', M);
      }
    ...
    (kF0 = function (D) {
      ...
      function W(F, J) {
        Z[F] = D[F]
          ? function (C) {
              return (Y = !Y) ? { value: yb(D[F](C)), done: !1 } : J ? J(C) : C;
            }
          : J;
      }
    }),
    (xF0 = function (D) {
      ...
      return Z
        ? Z.call(D)
        : ((D = typeof OG1 === 'function' ? OG1(D) : D[Symbol.iterator]()),
          (Y = {}),
          W('next'),
          W('throw'),
          W('return'),
  ...
  ((vF0 = function (D) {
    ...
    var Z = {};
    if (D != null) {
      for (var Y = I(D), W = 0; W < Y.length; W++) if (Y[W] !== 'default') TG1(Z, D, Y[W]);
    }
    return (Q(Z, D), Z);
  }),
    (bF0 = function (D) {
  ...
  ((uF0 = function (D) {
    ...
    A('__param', NF0),
    A('__esDecorate', $F0),
    A('__runInitializers', qF0),
    A('__propKey', MF0),
    A('__setFunctionName', LF0),
    A('__metadata', RF0),
    A('__awaiter', OF0),
    A('__generator', TF0),
    A('__exportStar', PF0),
    A('__createBinding', TG1),
    A('__values', OG1),
    A('__read', Rf1),
    A('__spread', SF0),
    A('__spreadArrays', _F0),
    A('__spreadArray', jF0),
    A('__await', yb),
    A('__asyncGenerator', yF0),
    A('__asyncDelegator', kF0),
    A('__asyncValues', xF0),
    A('__makeTemplateObject', fF0),
    A('__importStar', vF0),
    A('__importDefault', bF0),
    A('__classPrivateFieldGet', gF0),
    A('__classPrivateFieldSet', hF0),
    A('__classPrivateFieldIn', mF0),
    A('__addDisposableResource', dF0),
    A('__disposeResources', uF0),
    A('__rewriteRelativeImportExtension', pF0));
});
