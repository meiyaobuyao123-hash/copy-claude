...
(function (A) {
  ...
  else if (typeof wB1 === 'object' && typeof ou5 === 'object') A(Q(B, Q(ou5)));
  else A(Q(B));
  function Q(I, G) {
    if (I !== B)
  ...
  ((XnA = function (D, Z) {
    ...
    (LnA = function (D, Z) {
      for (var Y in D)
        if (Y !== 'default' && !Object.prototype.hasOwnProperty.call(Z, Y)) zB1(Z, D, Y);
    }),
    (zB1 = Object.create
      ? function (D, Z, Y, W) {
          if (W === void 0) W = Y;
    ...
    (RnA = function () {
      for (var D = [], Z = 0; Z < arguments.length; Z++) D = D.concat(TP1(arguments[Z]));
      return D;
    }),
    (OnA = function () {
    ...
    (df = function (D) {
      return this instanceof df ? ((this.v = D), this) : new df(D);
    }),
    (PnA = function (D, Z, Y) {
      ...
      function K(M) {
        M.value instanceof df ? Promise.resolve(M.value.v).then(U, N) : q(J[0][2], M);
      }
      function U(M) {
        V('next', M);
      }
    ...
    (SnA = function (D) {
      ...
      function W(F, J) {
        Z[F] = D[F]
          ? function (C) {
              return (Y = !Y) ? { value: df(D[F](C)), done: !1 } : J ? J(C) : C;
            }
          : J;
      }
    }),
    (_nA = function (D) {
      ...
      return Z
        ? Z.call(D)
        : ((D = typeof HB1 === 'function' ? HB1(D) : D[Symbol.iterator]()),
          (Y = {}),
          W('next'),
          W('throw'),
          W('return'),
  ...
  ((ynA = function (D) {
    ...
    var Z = {};
    if (D != null) {
      for (var Y = I(D), W = 0; W < Y.length; W++) if (Y[W] !== 'default') zB1(Z, D, Y[W]);
    }
    return (Q(Z, D), Z);
  }),
    (knA = function (D) {
  ...
  ((gnA = function (D) {
    ...
    A('__param', znA),
    A('__esDecorate', wnA),
    A('__runInitializers', EnA),
    A('__propKey', UnA),
    A('__setFunctionName', NnA),
    A('__metadata', $nA),
    A('__awaiter', qnA),
    A('__generator', MnA),
    A('__exportStar', LnA),
    A('__createBinding', zB1),
    A('__values', HB1),
    A('__read', TP1),
    A('__spread', RnA),
    A('__spreadArrays', OnA),
    A('__spreadArray', TnA),
    A('__await', df),
    A('__asyncGenerator', PnA),
    A('__asyncDelegator', SnA),
    A('__asyncValues', _nA),
    A('__makeTemplateObject', jnA),
    A('__importStar', ynA),
    A('__importDefault', knA),
    A('__classPrivateFieldGet', xnA),
    A('__classPrivateFieldSet', fnA),
    A('__classPrivateFieldIn', vnA),
    A('__addDisposableResource', bnA),
    A('__disposeResources', gnA),
    A('__rewriteRelativeImportExtension', hnA));
});
